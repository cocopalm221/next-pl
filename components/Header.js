...
const Header = () => {
  return (
    <>
      <Head>
        <title>프론트엔드 개발자 이혜영 포트폴리오</title>
        <meta
          name="description"
          content="프론트엔드 개발자 이혜영 포트폴리오"
        />
        <meta name="keyword" content="React.js, Next.js, portflio, 이혜영" />
        ...
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <Link href="/">
            <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
              <span className="ml-3 text-xl">h.young</span>
            </a>
          </Link>
